...
<body>
    ...
    <main>
        <section id="no-project">
            ...
            <a href="/Web-Development-v1/public/index.php?url=project/index" class="view-portfolio-btn">Back to Portfolio</a>
        </section>
    </main>
    <!-- Footer section -->
    <footer>
    ...
    <script src="/Web-Development-v1/public/js/script.js"></script>
</body>
</html>