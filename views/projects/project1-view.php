...
<head>
    ...
    <link rel="stylesheet" href="/Web-Development-v1/public/css/project.css">
    ...
    <main>
        ...
        <section id="project1">
            ...
            <div class="project-details">
                <img src="/Web-Development-v1/public/images/<?php echo $projectImage; ?>" alt="<?php echo $projectName; ?>" class="project-image">
