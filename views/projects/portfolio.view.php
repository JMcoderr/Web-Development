...
<head>
    ...
    <link rel="stylesheet" href="/Web-Development-v1/public/css/portfolio.css">
    ...
    <main>
        ...
        <section id="portfolio">
            ...
            <div class="project-grid">
                <div class="project">
                    <a href="/Web-Development-v1/public/index.php?url=project/showProject1">
                        <img src="/Web-Development-v1/public/images/webdevelopment1.jpg" alt="Project 1">
                ...
                <div class="project">
                    <a href="/Web-Development-v1/public/index.php?url=project/showNoProject">
                        <img src="/Web-Development-v1/public/images/project2.jpg" alt="Project 2">
                        <h3>Project 2</h3>
                ...
                <div class="project">
                    <a href="/Web-Development-v1/public/index.php?url=project/showNoProject">
                        <img src="/Web-Development-v1/public/images/project3.jpg" alt="Project 3">
                        <h3>Project 3</h3>
                        <p>Project is yet to be added.</p>
                        <p class="technologies"><strong>Technologies:</strong></p>
                        <p class="year"><strong>Year:</strong></p>
                ...
                <div class="project">
                    <a href="/Web-Development-v1/public/index.php?url=project/showNoProject">
                        <img src="/Web-Development-v1/public/images/project4.jpg" alt="Project 4">
                        <h3>Project 4</h3>
                        <p>Project is yet to be added.</p>
                        <p class="technologies"><strong>Technologies:</strong></p>
                        <p class="year"><strong>Year:</strong></p>
                ...
                <div class="project">
                    <a href="/Web-Development-v1/public/index.php?url=project/showNoProject">
                        <img src="/Web-Development-v1/public/images/project5.jpg" alt="Project 5">
                        <h3>Project 5</h3>
                        <p>Project is yet to be added.</p>
                        <p class="technologies"><strong>Technologies:</strong></p>
                        <p class="year"><strong>Year:</strong></p>
                ...
                <div class="project">
                    <a href="/Web-Development-v1/public/index.php?url=project/showNoProject">
                        <img src="/Web-Development-v1/public/images/project6.jpg" alt="Project 6">
                        <h3>Project 6</h3>
                        <p>Project is yet to be added.</p>
                        <p class="technologies"><strong>Technologies:</strong></p>
                        <p class="year"><strong>Year:</strong></p>
